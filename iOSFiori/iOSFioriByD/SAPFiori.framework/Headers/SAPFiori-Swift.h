...
SWIFT_CLASS("_TtC8SAPFiori13FUIAnnotation")
@interface FUIAnnotation : NSObject <MKAnnotation>
/// Coordinate info for the wrapper annotation.
...
SWIFT_CLASS("_TtC8SAPFiori15FUIKPIFormatter")
@interface FUIKPIFormatter : NSFormatter
...
///
/// \endcodeimportant:
/// Only data source using unique identifier could be sectioned. i.e., the
...
/// <h2>Usage</h2>
/// When configuring your map interface with <code>FUIMKMapView</code>, all of the added annotation and overlay objects and their corresponding display objects will be cached internally.
...
/// <ul>
///   <li>
///     <code>items</code>: a array of <code>FUIMapLegendItem</code> that will be displayed in the tableView.
///   </li>
/// </ul>
...
@interface FUIObjectView : FUIDrawingView
...
SWIFT_CLASS("_TtC8SAPFiori10FUIOverlay")
@interface FUIOverlay : NSObject <MKOverlay>
/// Bounding map rect info for the wrapper overlay.
@property (nonatomic, readonly) MKMapRect boundingMapRect;
/// Coordinate info for the wrapper overlay.
@property (nonatomic, readonly) CLLocationCoordinate2D coordinate;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
