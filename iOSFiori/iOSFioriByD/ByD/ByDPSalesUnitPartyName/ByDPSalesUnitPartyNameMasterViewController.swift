//
// ByDPSalesUnitPartyNameMasterViewController.swift
// ByD
//
...
class ByDPSalesUnitPartyNameMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    private let appDelegate = UIApplication.shared.delegate as! AppDelegate
    private var byDC: ByDC<OnlineODataProvider> {
        return self.appDelegate.byDC
    }

    public var loadEntitiesBlock: ((_ completionHandler: @escaping ([ByDPSalesUnitPartyName]?, Error?) -> Void) -> Void)?
    private var entities: [ByDPSalesUnitPartyName] = [ByDPSalesUnitPartyName]()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let salesunitpartyname = self.entities[indexPath.row]
        let cell = CellCreationHelper.objectCellWithNonEditableContent(tableView: tableView, indexPath: indexPath, key: "ObjectID", value: "\(salesunitpartyname.objectID!)")
        return cell
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! ByDPSalesUnitPartyNameDetailViewController
...
extension ByDPSalesUnitPartyNameMasterViewController: EntitySetUpdaterDelegate {
