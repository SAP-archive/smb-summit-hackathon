//
// ByDPBuyerPartyNameMasterViewController.swift
// ByD
//
...
class ByDPBuyerPartyNameMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    private let appDelegate = UIApplication.shared.delegate as! AppDelegate
    private var byDC: ByDC<OnlineODataProvider> {
        return self.appDelegate.byDC
    }

    public var loadEntitiesBlock: ((_ completionHandler: @escaping ([ByDPBuyerPartyName]?, Error?) -> Void) -> Void)?
    private var entities: [ByDPBuyerPartyName] = [ByDPBuyerPartyName]()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let buyerpartyname = self.entities[indexPath.row]
        let cell = CellCreationHelper.objectCellWithNonEditableContent(tableView: tableView, indexPath: indexPath, key: "ObjectID", value: "\(buyerpartyname.objectID!)")
        return cell
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! ByDPBuyerPartyNameDetailViewController
...
extension ByDPBuyerPartyNameMasterViewController: EntitySetUpdaterDelegate {
