//
// ByDPSalesOrderItemMasterViewController.swift
// ByD
//
...
class ByDPSalesOrderItemMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    private let appDelegate = UIApplication.shared.delegate as! AppDelegate
    private var byDC: ByDC<OnlineODataProvider> {
        return self.appDelegate.byDC
    }

    public var loadEntitiesBlock: ((_ completionHandler: @escaping ([ByDPSalesOrderItem]?, Error?) -> Void) -> Void)?
    private var entities: [ByDPSalesOrderItem] = [ByDPSalesOrderItem]()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = CellCreationHelper.objectCellWithNonEditableContent(tableView: tableView, indexPath: indexPath, key: "ObjectID", value: "\(salesorderitem.objectID!)")
        return cell
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! ByDPSalesOrderItemDetailViewController
...
extension ByDPSalesOrderItemMasterViewController: EntitySetUpdaterDelegate {
