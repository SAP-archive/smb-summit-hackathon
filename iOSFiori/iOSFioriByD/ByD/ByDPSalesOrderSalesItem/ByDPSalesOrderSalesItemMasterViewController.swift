//
// ByDPSalesOrderSalesItemMasterViewController.swift
// ByD
//
...
class ByDPSalesOrderSalesItemMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    private let appDelegate = UIApplication.shared.delegate as! AppDelegate
    private var byDC: ByDC<OnlineODataProvider> {
        return self.appDelegate.byDC
    }

    public var loadEntitiesBlock: ((_ completionHandler: @escaping ([ByDPSalesOrderSalesItem]?, Error?) -> Void) -> Void)?
    private var entities: [ByDPSalesOrderSalesItem] = [ByDPSalesOrderSalesItem]()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let salesordersalesitem = self.entities[indexPath.row]
        let cell = CellCreationHelper.objectCellWithNonEditableContent(tableView: tableView, indexPath: indexPath, key: "ObjectID", value: "\(salesordersalesitem.objectID!)")
        return cell
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! ByDPSalesOrderSalesItemDetailViewController
...
extension ByDPSalesOrderSalesItemMasterViewController: EntitySetUpdaterDelegate {
