//
// ByDPSalesOrderItemProductDetailViewController.swift
// ByD
//
...
class ByDPSalesOrderItemProductDetailViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    private var _entity: ByDPSalesOrderItemProduct?
    var allowsEditableCells = false
    var entity: ByDPSalesOrderItemProduct {
        get {
            if self._entity == nil {
    ...
    private let logger = Logger.shared(named: "ByDPSalesOrderItemProductMasterViewControllerLogger")
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "updateEntity" {
            ...
            let detailViewController = dest.viewControllers[0] as! ByDPSalesOrderItemProductDetailViewController
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            return self.cellForObjectID(tableView: tableView, indexPath: indexPath, currentEntity: self.entity, property: ByDPSalesOrderItemProduct.objectID)
        case 1:
            return self.cellForParentObjectID(tableView: tableView, indexPath: indexPath, currentEntity: self.entity, property: ByDPSalesOrderItemProduct.parentObjectID)
        case 2:
            return self.cellForProductID(tableView: tableView, indexPath: indexPath, currentEntity: self.entity, property: ByDPSalesOrderItemProduct.productID)
        case 3:
    ...
    override func tableView(_: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 3:
            ...
            self.byDC.loadProperty(ByDPSalesOrderItemProduct.salesOrder, into: self.entity) { error in
        ...
        case 4:
            ...
            self.byDC.loadProperty(ByDPSalesOrderItemProduct.salesOrderItem, into: self.entity) { error in
                self.hideFioriLoadingIndicator()
                if let error = error {
                    let alertController = UIAlertController(title: NSLocalizedString("keyErrorLoadingData", value: "Loading data failed!", comment: "XTIT: Title of loading data error pop up."), message: error.localizedDescription, preferredStyle: .alert)
                    alertController.addAction(UIAlertAction(title: self.okTitle, style: .default))
    ...
    private func cellForObjectID(tableView: UITableView, indexPath: IndexPath, currentEntity: ByDPSalesOrderItemProduct, property: Property) -> UITableViewCell {
        var value = ""
        ...
        return CellCreationHelper.cellForProperty(tableView: tableView, indexPath: indexPath, entity: self.entity, property: property, value: value, editingIsAllowed: self.allowsEditableCells, changeHandler: { (newValue: String) -> Bool in
            ...
            if newValue.isEmpty {
                ...
                if ByDPSalesOrderItemProduct.objectID.isOptional || newValue != "" {
    ...
    private func cellForParentObjectID(tableView: UITableView, indexPath: IndexPath, currentEntity: ByDPSalesOrderItemProduct, property: Property) -> UITableViewCell {
        var value = ""
        ...
        return CellCreationHelper.cellForProperty(tableView: tableView, indexPath: indexPath, entity: self.entity, property: property, value: value, editingIsAllowed: self.allowsEditableCells, changeHandler: { (newValue: String) -> Bool in
            ...
            if newValue.isEmpty {
                ...
                if ByDPSalesOrderItemProduct.parentObjectID.isOptional || newValue != "" {
    ...
    private func cellForProductID(tableView: UITableView, indexPath: IndexPath, currentEntity: ByDPSalesOrderItemProduct, property: Property) -> UITableViewCell {
        var value = ""
        ...
        return CellCreationHelper.cellForProperty(tableView: tableView, indexPath: indexPath, entity: self.entity, property: property, value: value, editingIsAllowed: self.allowsEditableCells, changeHandler: { (newValue: String) -> Bool in
            ...
            if newValue.isEmpty {
                ...
                if ByDPSalesOrderItemProduct.productID.isOptional || newValue != "" {
    ...
    func createEntityWithDefaultValues() -> ByDPSalesOrderItemProduct {
        let newEntity = ByDPSalesOrderItemProduct()
...
extension ByDPSalesOrderItemProductDetailViewController: EntityUpdaterDelegate {
    func entityHasChanged(_ entityValue: EntityValue?) {
        if let entity = entityValue {
            let currentEntity = entity as! ByDPSalesOrderItemProduct
