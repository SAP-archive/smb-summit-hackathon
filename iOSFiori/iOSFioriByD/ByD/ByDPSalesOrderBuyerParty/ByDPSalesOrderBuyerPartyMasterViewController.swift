//
// ByDPSalesOrderBuyerPartyMasterViewController.swift
// ByD
//
...
class ByDPSalesOrderBuyerPartyMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    private let appDelegate = UIApplication.shared.delegate as! AppDelegate
    private var byDC: ByDC<OnlineODataProvider> {
        return self.appDelegate.byDC
    }

    public var loadEntitiesBlock: ((_ completionHandler: @escaping ([ByDPSalesOrderBuyerParty]?, Error?) -> Void) -> Void)?
    private var entities: [ByDPSalesOrderBuyerParty] = [ByDPSalesOrderBuyerParty]()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let salesorderbuyerparty = self.entities[indexPath.row]
        let cell = CellCreationHelper.objectCellWithNonEditableContent(tableView: tableView, indexPath: indexPath, key: "ObjectID", value: "\(salesorderbuyerparty.objectID!)")
        return cell
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! ByDPSalesOrderBuyerPartyDetailViewController
...
extension ByDPSalesOrderBuyerPartyMasterViewController: EntitySetUpdaterDelegate {
