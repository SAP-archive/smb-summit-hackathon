...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.bydproduct.Material Material}. Instances of this object are used in query modifier methods of the entity
    ...
    implements MaterialSelectable
{
     ...
     */
    public MaterialField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public MaterialField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
